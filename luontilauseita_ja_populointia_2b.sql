...
FOREIGN KEY(tekijaID) REFERENCES musiikintekija(tekijäID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY(teosID) REFERENCES teos(teosID) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(tekijaID) REFERENCES tekijä(tekijaID) ON UPDATE CASCADE ON DELETE NO ACTION,
...
käyttajatunnus VARCHAR(30) PRIMARY KEY,
laskuNro INTEGER PRIMARY KEY,
